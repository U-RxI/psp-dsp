...
def test_rms_1():
    ...
    UL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile1_50Hz_UL1_rms.csv',
                             delimiter=',', dtype=np.float64)
    
    
    IL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile1_50Hz_IL1_rms.csv',
                             delimiter=',', dtype=np.float64)
...
def test_rms_2():
    ...
    UL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_UL1_rms.csv',
                             delimiter=',', dtype=np.float64)
    UL2_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_UL2_rms.csv',
                         delimiter=',', dtype=np.float64)
    UL3_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_UL3_rms.csv',
                         delimiter=',', dtype=np.float64)
    
    IL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_IL1_rms.csv',
                             delimiter=',', dtype=np.float64)
    IL2_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_IL2_rms.csv',
                         delimiter=',', dtype=np.float64)
    IL3_rms_res = np.loadtxt('./tests/results/50Hz/testfile2_50Hz_IL3_rms.csv',
                     delimiter=',', dtype=np.float64)    
...
def test_rms_3():
    ...
    UL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_UL1_rms.csv',
                             delimiter=',', dtype=np.float64)
    UL2_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_UL2_rms.csv',
                         delimiter=',', dtype=np.float64)
    UL3_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_UL3_rms.csv',
                         delimiter=',', dtype=np.float64)
    
    IL1_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_IL1_rms.csv',
                             delimiter=',', dtype=np.float64)
    IL2_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_IL2_rms.csv',
                         delimiter=',', dtype=np.float64)
    IL3_rms_res = np.loadtxt('./tests/results/50Hz/testfile3_50Hz_IL3_rms.csv',
                     delimiter=',', dtype=np.float64)    
